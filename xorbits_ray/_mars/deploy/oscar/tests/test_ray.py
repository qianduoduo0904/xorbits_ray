...
import numpy as np
import pytest
from xorbits._mars import dataframe as md
from xorbits._mars import tensor as mt
from xorbits._mars.deploy.oscar.session import get_default_session, new_session
from xorbits._mars.deploy.oscar.tests import test_local
from xorbits._mars.deploy.oscar.tests.modules.utils import (  # noqa: F401  # pylint: disable=unused-variable
    cleanup_third_party_modules_output,
    get_output_filenames,
)
from xorbits._mars.tests.core import DICT_NOT_EMPTY, mock, require_ray
from xorbits._mars.utils import lazy_import
from xoscar.errors import ReconstructWorkerError
...
@pytest.mark.parametrize(
    ...
    [
        {
            "config": {
                "task.task_preprocessor_cls": "xorbits_ray._mars.deploy.oscar.tests.test_clean_up_and_restore_func.RayBackendFuncTaskPreprocessor",
                "subtask.subtask_processor_cls": "xorbits_ray._mars.deploy.oscar.tests.test_clean_up_and_restore_func.RayBackendFuncSubtaskProcessor",
            }
        }
    ],
    indirect=True,
...
@require_ray
@pytest.mark.asyncio
@mock.patch("xorbits_ray._mars.deploy.oscar.ray.stop_worker")
