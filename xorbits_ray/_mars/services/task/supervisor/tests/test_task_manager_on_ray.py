...
import pytest
import xoscar as mo
from xorbits._mars.services.task.supervisor.manager import TaskConfigurationActor
from xorbits._mars.tests.core import require_ray
from xoscar.utils import lazy_import
from xoscar_ray.backends.ray.utils import placement_group_info_to_addresses
